export class TitleScene extends Phaser.Scene {
    ...
    create() {
        ...
        //title
        this.add.text(350, 100, 'May I?').setFontSize(100).setFontFamily('Impact').setColor('#2335a8').setShadow(2, 5, '#333333');
        ...
        //buttons
        let newButton = this.add.text(150, 400, 'New Game').setFontSize(50).setFontFamily('Impact').setColor('#2335a8').setShadow(2, 3, '#333333').setInteractive({ useHandCursor: true });
        let joinButton = this.add.text(600, 400, 'Join Game').setFontSize(50).setFontFamily('Impact').setColor('#2335a8').setShadow(2, 3, '#333333').setInteractive({ useHandCursor: true });
        let rulesButton = this.add.text(448, 400, 'Rules').setFontSize(25).setFontFamily('Impact').setColor('#2335a8').setShadow(1, 1, '#333333').setInteractive({ useHandCursor: true });
        let creditsButton = this.add.text(440, 450, 'Credits').setFontSize(25).setFontFamily('Impact').setColor('#2335a8').setShadow(1, 1, '#333333').setInteractive({ useHandCursor: true });
